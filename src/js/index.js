...
botaoAlterarTema.addEventListener("click", () => {
    ...
    // o "remove" e "add" inserido no if e no else, podem ser susbstituidos pelo "toggle", inserindo antes da condição para dininuir o codigo, ex:"body.classList.toggle("modo-escuro");
